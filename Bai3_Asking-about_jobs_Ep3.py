...
from create_intro_hook_advice_practice import add_cute_speech_bubble
...
("Paul", "Hi Susan, I’m good, thanks. How about you?", "Mình khỏe, cảm ơn. Còn bạn thì sao?", "male"),

("Susan", "I’m fine too. By the way, can I ask you something?", "Mình cũng khỏe. à mà này, mình có thể hỏi bạn một điều không?", "female"),
("Paul", "Sure, go ahead. It’s not another math question, right?", "Được chứ. Không phải lại là câu hỏi toán nữa đấy chứ?", "male"),

("Susan", "Haha, no. What does your dad do?", "Ha ha, không đâu. Ba bạn làm nghề gì vậy?", "female"),
...
("Paul", "Yeah, sometimes I think he can talk to them.", "Vâng, đôi khi mình nghĩ ba mình có thể nói chuyện với chúng đấy.", "male"),

("Susan", "Really? Maybe the machines talk back to him!", "Thật à? Có khi máy móc cũng nói chuyện lại với bác ấy đấy!", "female"),
("Paul", "Haha, that explains why he fixes them so quickly.", "Ha ha, điều đó giải thích vì sao ông sửa chúng nhanh như vậy.", "male"),

("Susan", "Maybe! How about your mom?", "Có thể lắm! Còn mẹ bạn thì sao?", "female"),
("Paul", "My mom is a nurse. She always tells me to sleep earlier.", "Mẹ mình là y tá. Lúc nào bà cũng bảo mình đi ngủ sớm.", "male"),

("Susan", "I think that's because moms love their children very much.", "Mình nghĩ đó là vì các bà mẹ rất yêu thương con cái.", "female"),
("Paul", "Yes, I think so.", "Ừ, mình cũng nghĩ vậy.", "male"),

("Paul", "And what about your mom?", "Thế còn mẹ bạn thì sao?", "male"),
("Susan", "My mom is a math teacher, and she will teach our class tomorrow.", "Mẹ mình là giáo viên dạy toán, và bà sẽ dạy lớp chúng ta vào ngày mai.", "female"),

("Paul", "Oh no, there’s no escape from math!", "Ôi không, vậy là không thể trốn khỏi môn toán rồi!", "male"),
]
...
INTRO = "Chào tất cả các bạn đã quay trở lại!\nChúc các bạn một ngày tốt lành.\nCùng bắt đầu nào!"
INTRO_EN = "Welcome back everyone!\nHave a wonderful day.\n Let's begin!"

hook_vi = "Hôm nay hãy cùng nói về nghề nghiệp và gia đình nhé."
hook_us = """
Let's talk about jobs and family.
"""

topic_vi = """Bài 3: Nói về nghề nghiệp và gia đình?\n
...
topic_us = """Lesson 3: Jobs and Family\n
"""
topic_us_text= "You will learn:\n"
topic_us_main = """
How to ask about jobs and Family"""

lesson_text = "Lesson 3:"
main_text = "Jobs and Family"
...
Sometimes I think he can talk to machines.
My mom is a nurse.
I think that's because moms love their children very much.
My mom is a math teacher.
"""

practice_vi = "Đây là mẫu bài luyện tập. Các bạn có thể dừng video để làm nhé"
practice_us = """
1. What does your dad _____?
2. My dad is a _____.
3. He fixes _____ in a garage.
4. Sometimes I think he can talk to _____.
5. My mom is a _____.
6. She always tells me to sleep _____.
7. Moms love their _____ very much.
8. My mom is a math _____.
9. She started teaching at our _____ yesterday.
10. There is no escape from _____.
"""
...
FONT_VI = ImageFont.truetype(r"C:/Windows/Fonts/arial.ttf", 26)
...
def add_speech_bubble(base_image_path, output_path, text_us, scene, text_vi=None, show_vi=True):
    ...
    y = img.height - bubble_height - 500
...
def draw_text_importantSaying_practice(base_image_path, output_path, text_us):
    ...
    wrapped_text = wrap_keep_newlines(text_us, width=40)
