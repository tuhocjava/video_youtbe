...
dialogues = [
    ...
    ("Kate", "Uh-oh. Did you forget your homework again?", "Ôi không. Lại quên làm bài tập à?", "female"),

    ("Adam", "Worse. I have to speak in front of the class later.", "Còn tệ hơn. Lát nữa mình phải nói trước lớp.", "male"),

    ("Kate", "Ah, that's why you look so serious today.", "À, bảo sao hôm nay trông bạn nghiêm túc thế.", "female"),

    ("Adam", "I even practiced in front of the mirror last night.","Tối qua mình còn tập trước gương nữa.", "male"),

    ("Kate", "And did the mirror give you a good score?", "Và cái gương có chấm điểm cao cho bạn không?", "female"),

    ("Adam", "Haha, no. It just copied my nervous face.", "Haha, không. Nó chỉ bắt chước gương mặt lo lắng của mình thôi.", "male"),
    
    ("Kate", "Oh, no. Good luck!", "Ôi không, chúc bạn may mắn nhé.", "female"),
    
    ("Adam", "Thanks. If I survive, I'll tell you how it goes.", "Cảm ơn nhé. Nếu mình sống sót, mình sẽ kể cho bạn nghe sau.", "male"),

    ("Kate", "Great! By the way, I’m in a great mood today.", "Hay lắm! À mà này. Hôm nay mình rất vui.", "female"),

    ("Adam", "Really? What happened?", "Thật à? Có chuyện gì thế?", "male"),

    ("Kate",  "We don't have any homework tonight.", "Tối nay chúng ta không có bài tập về nhà.", "female"),

    ("Adam", "Now that's the best news I've heard all day.", "Đó đúng là tin vui nhất mình nghe cả ngày.", "male"),
]
KICH_BAN = [
    {
        "nhan_vat": character,
...
hook_vi = "Bạn có thấy hồi hộp khi nói trước lớp không?"
hook_us = "Do you get nervous when speaking in front of your class?"

topic_vi = """Bài 6: Những tâm trạng khác nhau\n

Hôm nay bạn sẽ học:\n
Nói về cảm xúc với bạn bè
"""
topic_us = """Lesson 6: Diffirent Moods\n
"""
topic_us_text= "You will learn:\n"
topic_us_main = """
Talking About Feelings with Friends"""

lesson_text = "Lesson 6:"
main_text = "Diffirent Moods"
...
I have to speak in front of the class later.\n
I practiced in front of the mirror last night.\n
Good luck!\n
...
2. I have to speak in front of the ______ later.
3. I practiced in front of the ______ last night.
4. Good ______!
5. I'm in a great ______ today.
6. We don't have any ______ tonight.
7. That's the best ______ I've heard all day.
"""
