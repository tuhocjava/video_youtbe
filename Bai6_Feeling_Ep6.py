...
# =========================
dialogues = [
    ("Kate", "Hey Adam, how’s it going?", "Chào Adam, dạo này thế nào?", "female"),
    ("Adam", "I’m feeling a bit nervous today.", "Hôm nay mình hơi lo lắng.", "male"),
    ("Kate", "Nervous? That doesn’t sound fun.", "Lo lắng à? Nghe không vui chút nào.", "female"),
    ("Adam", "Yeah, I’ve got to speak in front of the class later.", "Ừ, lát nữa mình phải nói trước lớp.", "male"),
    ("Kate", "Oh, I get it. Public speaking can be scary.", "Ồ, mình hiểu. Nói trước đám đông đúng là đáng sợ.", "female"),
    ("Adam", "Exactly. My hands are already shaking.", "Đúng vậy. Tay mình đã run rồi.", "male"),
    ("Kate", "Haha, don’t worry.Picture everyone clapping and smiling.", "Haha, đừng lo. Cứ hình dung mọi người đang vỗ tay và mĩm cười.", "female"),
    ("Adam", "That would make me laugh instead of panic.", "Như vậy chắc mình sẽ cười thay vì hoảng.", "male"),
    ("Kate", "See? Laughter helps. I’m actually in a good mood today.", "Thấy chưa? Cười sẽ giúp. Thật ra hôm nay mình rất vui.", "female"),
    ("Adam", "Nice! What’s making you so cheerful?", "Tuyệt! Điều gì làm bạn vui thế?", "male"),
    ("Kate", "I had pancakes for breakfast. Pancakes always make me happy.", "Sáng nay mình ăn bánh pancake. Pancake luôn làm mình vui.", "female"),
    ("Adam", "Haha, food is the best mood booster.", "Haha, đồ ăn đúng là liều thuốc tinh thần tốt nhất.", "male"),
    ("Kate", "Totally! Maybe after your speech, we can celebrate with ice cream.", "Chắc chắn rồi! Sau bài nói, chúng ta có thể ăn kem mừng.", "female"),
    ("Adam", "Deal! Ice cream sounds like the perfect reward.", "Nhất trí! Kem nghe như phần thưởng tuyệt vời.", "male"),
    ("Kate", "So, don’t stress too much. Think of the ice cream waiting for you.", "Vậy nên đừng căng thẳng quá. Hãy nghĩ đến kem đang chờ bạn.", "female"),
    ("Adam", "You’re right. Talking to you makes me feel braver already.", "Bạn nói đúng. Nói chuyện với bạn làm mình thấy dũng cảm hơn rồi.", "male")
]
...
hook_vi = "Hiểu cảm xúc để yêu thương nhiều hơn. Cùng học cách nói về cảm xúc bằng tiếng Anh nhé!"
hook_us = "Understand feelings to love more. Let’s learn how to talk about emotions in English!"
topic_vi = "Bài 6: Nói về cảm xúc, tâm trạng"
topic_us = "Lesson 6: Talking about Feeling"
