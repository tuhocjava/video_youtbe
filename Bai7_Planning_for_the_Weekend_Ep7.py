...
# =========================
dialogues = [
("Emma", "Hi Jack! When do you do your homework?", "Chào Jack! Bạn làm bài tập về nhà khi nào?", "female"),
("Jack", "Hi Emma! I do my homework after school.", "Chào Emma! Mình làm bài tập về nhà sau giờ học.", "male"),
("Emma", "Do you make a study plan?", "Bạn có lập kế hoạch học tập không?", "female"),
("Jack", "Yes, I do. It helps me a lot.", "Có. Nó giúp mình rất nhiều.", "male"),
("Emma", "What do you do first?", "Bạn làm gì trước tiên?", "female"),
("Jack", "I do my math homework first.", "Mình làm bài tập Toán trước.", "male"),
("Emma", "Why do you do math first?", "Tại sao bạn làm Toán trước?", "female"),
("Jack", "Because it is a little hard for me.", "Vì nó hơi khó với mình.", "male"),
("Emma", "What do you do after that?", "Bạn làm gì sau đó?", "female"),
("Jack", "I do my English homework.", "Mình làm bài tập tiếng Anh.", "male"),
("Emma", "Do you take a break?", "Bạn có nghỉ giải lao không?", "female"),
("Jack", "Yes, I take a short break.", "Có, mình nghỉ ngắn một chút.", "male"),
("Emma", "That is a good idea.", "Đó là một ý tưởng hay.", "female"),
("Jack", "After homework, I check my work again.", "Sau khi làm bài xong, mình kiểm tra lại bài.", "male"),
("Emma", "Great! A good plan helps us study better.", "Tuyệt vời! Một kế hoạch tốt giúp chúng ta học tốt hơn.", "female")
]
...
topic_vi = "Bài 7: Lên kế hoạch cho cuối tuần."
topic_us = "Lesson 7: Planning for the Weekend"
...
def add_speech_bubble(base_image_path, output_path,text, scene):
    ...
    if scene["sex"] == "female":
        ...
        x = head_x - bubble_width + 450
        y = head_y - bubble_height +110
