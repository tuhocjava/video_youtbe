...
dialogues = [
    ...
    ("Ethan", "Your salad looks fresh, and the fruit looks sweet.",
     "Salad của bạn trông rất tươi, và trái cây có vẻ rất ngọt.", "male"),
...
hook_vi = "Bạn ăn trưa ở căng tin trường hay mang theo từ nhà?"
hook_us = """Do you eat lunch in the school canteen or bring it from home?"""

topic_vi = """Bài 4: Ăn trưa ở căng tin nhà trường\n

Hôm nay bạn sẽ học:\n
Bữa trưa ở trường và thức ăn
"""
topic_us = """Lesson 3: Having lunch at the school canteen\n
"""
...
main_text = "Having lunch at the school canteen"
...
important_saying_us = """
Do you smell that delicious food?\n
The smell is making me hungry.\n
Let's go to the canteen for lunch.\n
What would you like to eat today?\n
I think I'll get some sandwiches.\n
These sandwiches taste wonderful!\n
The food at the school canteen is really good.
"""

practice_vi = "Đây là mẫu bài luyện tập. Các bạn có thể dừng video để làm nhé"
practice_us = """
1. Do you _____ that delicious food?
2. The smell is making me _____.
3. Let's go to the _____ for lunch.
4. What would you like to _____ today?
5. I think I'll get some _____.
6. The lunch line is not too _____ today.
7. We can get our food _____.
8. These sandwiches taste _____.
9. The fruit looks _____.
10. The food at the school canteen is really _____.
"""
...
def add_speech_bubble(base_image_path, output_path, text_us, scene, text_vi=None, show_vi=True):
    ...
    if scene["sex"] == "female" and len(faces) >= 1:
        a, b, w, h = faces[0]
        x = (a + img.width + w - bubble_width) / 2 -200
