...
# from create_thumbnail_intro_hook_dinamic_text import make_thumbnail_with_text
...
# =========================
dialogues = [
    ("Sophia", "Hi! I'm Sophia. What's your name?", "Xin chào! Mình là Sophia. Tên bạn là gì?", "female"),
    ("Mike", "Hi, Sophia. I'm Mike.", "Chào Sophia. Mình là Mike.", "male"),
    ("Sophia", "Nice to meet you, Mike.", "Rất vui được gặp bạn, Mike.", "female"),
    ("Mike", "Nice to meet you too.", "Mình cũng rất vui được gặp bạn.", "male"),
    ("Sophia", "Are you new here?", "Bạn là học sinh mới ở đây à?", "female"),
    ("Mike", "Yes. I'm a little nervous", "Nên mình có chút hồi hộp.", "male"),
    ("Sophia", "Don't worry. I'm new here too.", "Đừng lo lắng. Mình cũng vậy! .", "female"),
    ("Sophia", "Do you know where our classroom is?", "Bạn biết lớp học ở đâu không?", "female"),
    ("Mike", "No, but if you're hungry, I know exactly where to go.", "Không, nhưng nếu bạn đói thì mình biết chính xác phải đi đâu.", "male"),
    ("Sophia", "Haha! That's funny. Let's be friends.", "Ha ha! Nghe vui đấy. Chúng ta kết bạn nhé.", "female"),
    ("Sophia", "Now, let's find our class.", "Bây giờ, cùng tìm lớp nhé.", "female"),
    ("Mike", "Okay. Let's go.", "Được. Cùng đi nào", "male")
]
...
practice_us = """
A: Hi! I'm ____. What's your name?\n
B: Hi, ____. I'm ____.\n
A: Nice to ____ you.\n
B: Nice to meet you ___.\n
A: Are you ____ here?\n
B: Yes. I'm new.\n
A: Let's ____ friends.\n
B: Yes!
"""
...
async def audio_topic_hook_importantSaying(topic_vi, topic_us, file_out, ting_path=None, is_importantSaying = False):
    return await create_tts_audio(
        file_out=file_out,
        vi_text=topic_vi,
        us_text=topic_us,
...
def draw_text_importantSaying_practice(base_image_path, output_path, text_us):
    ...
    wrapped_text = wrap_keep_newlines(text_us, width=30)
...
async def main():
    ...
    # Tạo ảnh iNtro
    print("Tạo ảnh intro")
    # add_cute_speech_bubble(Path(f"{BASE_DIR}/image/female.png"),
    ...
    #Hook
    # Tạo hook audio
    await audio_topic_hook_importantSaying(hook_vi, hook_us, f"{BASE_DIR}/audio/hook.mp3")
    ...
    await audio_topic_hook_importantSaying(topic_vi,
                                       ...
                                       ting_path = "for_youtube/ting.mp3")
    ...
    await audio_topic_hook_importantSaying(important_saying_vi,
                                           ...
                                           ting_path = "for_youtube/ting.mp3", is_importantSaying=True)
