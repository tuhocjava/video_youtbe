...
BASE_DIR = "Ep2/output"
DOWNLOAD_DIR = "Ep2/download"

# =========================
# 1. Kịch bản hội thoại
# =========================
dialogues = [
("Anna", "Hey Danny, can I ask you something?", "Này Danny, mình có thể hỏi bạn một điều không?", "female"),

("Danny", "Of course. What is it?", "Tất nhiên rồi. Chuyện gì vậy?", "male"),

("Anna", "How old are you?", "Bạn bao nhiêu tuổi rồi?", "female"),

("Danny", "I'm 16 years old. How about you?", "Mình 16 tuổi. Còn bạn?", "male"),

("Anna", "I'm 14 years old.", "Mình 14 tuổi.", "female"),

("Danny", "Wow, I'm the same age as your older brother.", "Ồ, mình bằng tuổi anh trai của bạn đấy.", "male"),

("Danny", "Maybe you should call me big brother too!", "Có lẽ bạn cũng nên gọi mình là anh trai đi!", "male"),

("Anna", "Really? But we're in the same class.", "Thật sao? Nhưng chúng ta học cùng lớp mà.", "female"),

("Anna", "Ah, I think I'm smarter than you.", "À, Mình nghĩ mình còn thông minh hơn bạn đấy.", "female"),

("Danny", "Haha, OK, OK. I was just joking.", "Ha ha, được rồi, được rồi. Mình chỉ đùa thôi mà.", "male"),

("Anna", "Good! Otherwise I'd have to teach you a lesson.", "Tốt! Nếu không mình phải dạy cho bạn một bài học đấy.", "female")
]
...
hook_vi = "Bạn bao nhiêu tuổi? Cùng nhau hỏi các bạn trong lớp bằng tiếng anh nhé"
hook_us = """How old are you?
Learn to ask and answer
age in English"""

topic_vi = """Bài 2: Bạn bao nhiêu tuổi?

Hôm nay bạn sẽ học:

Cách hỏi tuổi bằng tiếng Anh.
Cách trả lời tuổi của mình.
Cách so sánh tuổi.
Nói đùa với bạn bè.
"""

topic_us = """Lesson 2: How Old Are You?.\n
"""
...
lesson_text = "Lesson 2:"
main_text = "How old are you?"
...
I'm 14 years old.\n
How about you?\n
I'm the same age as your older brother.\n
I was just joking\n
...
practice_us = """
1. How _____ are you?\n
2. I'm _____ years old.\n
3. How _____ you?\n
4. I'm the same _____ as your older brother.\n
5. Being _____ doesn't mean being smarter.\n
6. Let's learn from _____ other.\n
7. Maybe you should call me _____ brother too!\n
8. I think I'm _____ than you.
"""
...
def draw_text_importantSaying_practice(base_image_path, output_path, text_us):
    ...
    wrapped_text = wrap_keep_newlines(text_us, width=50)
